          ...
          >
            {pillars.map((pillar, index) => (
              <button
                ...
                className={`flex items-center justify-center gap-2 px-3 sm:px-4 py-3 rounded-[28px] font-heading text-xs sm:text-sm font-medium transition-all duration-200 focus:outline-none ${
                  activeTab === index
              ...
              >
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="relative">
                    <div 
                      className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl flex-shrink-0 ${
                  ...
                  <div className="space-y-3">
                    {pricingPlans.map((plan, index) => (
                      <div 
                        ...
                        className={`backdrop-blur-sm rounded-xl p-4 sm:p-5 cursor-pointer transition-all duration-200 ${
