        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="space-y-3 text-gray-700">
                  <p><strong>Email:</strong> contact@trippechalo.in</p>
                  <p><strong>Phone:</strong> +91 9685609494 / +91 9669614697</p>
                  <p><strong>Customer Support:</strong> contact@trippechalo.in</p>
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mt-4">
                <p className="text-gray-700"><strong>Legal Department:</strong> contact@trippechalo.in</p>
